...
class TestBase(LiveServerTestCase):
    ...
    def setUp(self):
        ...
        self.driver = webdriver.Chrome(executable_path="/home/chrisburd91/flask-app/chromedriver", chrome_options=chrome_options)
...
class TestRegistration(TestBase):
    ...
    def test_registration(self):
        ...
        self.driver.find_element_by_xpath('//*[@id="email"]-email').send_keys(test_admin_email)
